...
const initialValue = [
  ...
  },
  {
    ...
    description:
      "Membantu kamu untuk menemukan tempat wisata terbaik yang sesuai dengan keinginan sebelum memulai petualangan mu di Banten.",
  },
  {
    id: uuidv4(),
    title: "BERITA WISATA",
    ...
    description:
      "Dapatkan berita terkini seputar destinasi wisata yang ada di Banten untuk kamu yang menarik untuk dibaca.",
  },
  {
    id: uuidv4(),
    ...
    description:
      "Menyajikan berita terhangat yang menarik dan informatif sebagai bacaan yang mermanfaat untuk mengisi waktu kosong liburanmu.",
  },
  {
    id: uuidv4(),
    ...
    description:
      "Kunjungi destinasi wisata kuliner terbaik untuk menghilangkan lapar dan haus agar mengembalikan energimu disaat berlibur.",
  },
];
...
export const { submitContent, handleDelete, handleUpdate } =
  contentsReducer.actions;
