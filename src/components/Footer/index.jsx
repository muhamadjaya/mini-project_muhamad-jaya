...
const Footer = () => {
  ...
  const handleOpenWa = () => {
    window.open(
      "https://wa.me/087876151046?text=Hi%27,%20like%20to%20chat%20with%20you"
    );
  };
          ...
          <div className="row pt-5">
            <div className="col-12 col-lg-6">
              <div className="footer-item">
                ...
                <div className="footer-desc pt-4">
                  Bantentourism adalah website penyedia rekomendasi destinasi
                  wisata Provinsi Banten yang dikelola oleh Muhamad Jaya.
                </div>
                <div className="footer-social-box pt-4">
                  <span className="fs-5 fw-bold pe-4">FOLLOW ME</span>
                  <i
                    className="bi bi-facebook fs-4 pe-3 bi-icon"
                    onClick={handleOpenFb}
                  ></i>
                  <i
                    className="bi bi-twitter fs-4 pe-3 bi-icon"
                    onClick={handleOpenTwitter}
                  ></i>
                  <i
                    className="bi bi-instagram fs-4 pe-3 bi-icon"
          ...
          <div className="row pt-5">
            <div className="col-12 col-lg-12">
              ...
              <p className="text-center footer-text pt-4">
                ...
                <i className="bi bi-heart-fill text-danger"></i> by Muhamad Jaya
              </p>
            </div>
          </div>
        </div>
