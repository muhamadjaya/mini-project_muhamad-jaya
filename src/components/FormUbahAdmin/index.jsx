              ...
              <form onSubmit={handleSubmit} onReset={handleReset}>
                ...
                <div className="row mb-3">
                  ...
                  <div className="col-sm-10">
                    ...
                    <input
                      className="form-check-input mt-2 pt-3"
                      type="checkbox"
                      value=""
                      id="flexCheckDefault-lama"
                      onClick={togglePassword}
                    />
                    <label
                      className="form-check-label mt-1 ms-2"
                      htmlFor="flexCheckDefault-lama"
                    >
                      Tampilkan Password
                    </label>
                  </div>
                ...
                <div className="row mb-3">
                  ...
                  <div className="col-sm-10">
                    ...
                    <input
                      ...
                      type="checkbox"
                      value=""
                      id="flexCheckDefault-baru"
                      onClick={togglePassword2}
                    />
                    <label
                      className="form-check-label mt-1 ms-2"
                      htmlFor="flexCheckDefault-baru"
                    >
                      Tampilkan Password
                    </label>
                  </div>
                ...
                <div className="row mb-3">
                  <label
                    htmlFor="input-konfirmasi-password-baru"
                    className="col-sm-2 col-form-label"
                  >
                  ...
                  <div className="col-sm-10">
                    ...
                    <input
                      ...
                      type="checkbox"
                      value=""
                      id="flexCheckDefault-konfirmasi"
                      onClick={togglePassword3}
                    />
                    <label
                      className="form-check-label mt-1 ms-2"
                      htmlFor="flexCheckDefault-konfirmasi"
                    >
                      Tampilkan Password
                    </label>
                  </div>
